...
\metroset{titleformat=lowercase}
...
\definecolor{airforceblue}{HTML}{00416A}
\definecolor{falured}{HTML}{801818}

%% You can redefine colours, mostly by borrowing from Beamer
\setbeamercolor{frametitle}{bg=airforceblue}

%% You also use hyperref, and pick colors 
\hypersetup{colorlinks, citecolor=falured,filecolor=falured,linkcolor=airforceblue,urlcolor=falured}
